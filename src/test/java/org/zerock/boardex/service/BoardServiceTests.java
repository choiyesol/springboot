...
public class BoardServiceTests {
    ...
    // 데이터 조회 시 게시글과 첨부파일을 같이 처리하는지 테스트
    @Test
    ...
    public void testListWithAll() {
        // 1번 페이지의 글 목록 10개만 가져와서 pageRequestDTO 에 저장
        PageRequestDTO pageRequestDTO=PageRequestDTO.builder()
                .page(1)
                .size(10)
                .build();
        // 페이지 객체 안의 게시글 목록 포함해서 boardService의 listWithAll 메서드 호출한 다음 실행결과를 responseDTO에 저장
